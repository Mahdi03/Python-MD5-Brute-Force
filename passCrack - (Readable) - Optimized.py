# Required to Run Multiple Processes At Once (Better Time Optimization Of For Loops)
...
def main():
    ...
    if __name__ == "__main__":
        ...
        processa = Thread(target=a)
        processb = Thread(target=b)
        processa.start()
        processa.run()
        processa.join()
        processb.start()
